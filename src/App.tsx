...
import AnyPageRenderer from "./pages/anypage/index";
import SupabaseRjsfPageRenderer from "./pages/supabaseRjsfPage/index";
    ...
    return (
        <BrowserRouter>
            <ConfigProvider theme={RefineThemes.Blue}>
                <Refine
                    dataProvider={{default:dataProvider(supabaseClient), genericRest:simpleRestProvider(JSON_SERVER_URL)}}
                    ...
                    <Routes>
                        ...
                        >
                            <Route
                                index
                                element={
                                    <NavigateToResource resource="partner" />
                                }
                            />
                            <Route path="/partner">
                                <Route index element={<AntdInferencer />} />
                                <Route path="list" element={<AntdInferencer />} />
                                <Route path="create" element={<AntdInferencer />} />
                                <Route path="edit/:id" element={<SupabaseRjsfPageRenderer pageName="partner" />} />
                            ...
                            <Route path="/customer">
                                ...
                                <Route path="list" element={<AntdInferencer />} />
                                <Route path="create" element={<AntdInferencer />} />
                                <Route path="edit/:id" element={<AnyPageRenderer pageName="customer" />} />
                                <Route path="show/:id" element={<AntdInferencer />} />
                            </Route>
                        </Route>
